(function () {
  ...
  var products = [
    ...
    { weight: '1kg', format: 'graos', label: 'Em grãos', name: 'Itajaó Especial 1kg em Grãos', copy: 'Dois pacotes de 500g para preservar melhor o frescor.', image: 'assets/images/products/real/graos-1kg-kit.jpg' },
    { weight: '1kg', format: 'moido', label: 'Moído', name: 'Itajaó Especial 1kg Moído', copy: 'Dois pacotes de 500g já moídos para o dia a dia.', image: 'assets/images/products/real/moido-1kg-kit.jpg' },
    { weight: '3kg', format: 'graos volume', label: 'Em grãos', name: 'Kit Itajaó 3kg em Grãos', copy: 'Volume para escritórios, cafeterias e rotinas de maior consumo.', image: 'assets/images/products/real/graos-3kg-kit.jpg' },
    { weight: '3kg', format: 'moido volume', label: 'Moído', name: 'Kit Itajaó 3kg Moído', copy: 'Seis pacotes de 500g com moagem prática para coador.', image: 'assets/images/products/real/moido-3kg-kit.jpg' },
  ...
  function card(product, liveProduct) {
    ...
    var price = available ? store.money(liveProduct.price) : 'Sob consulta';
    var priceNote = available ? 'Preço atualizado no catálogo' : 'Confirmamos preço, estoque e entrega no atendimento';
